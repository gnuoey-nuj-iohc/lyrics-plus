...
Provide ONLY the ${targetLang} translation, line by line, with no original language text remaining. Make it sound natural and beautiful:`;
  ...
  static _getApiKeys() {
    ...
    // 캐시 갱신
    const perplexityKey = StorageManager.getItem("lyrics-plus:visual:perplexity-api-key");
    const geminiKey = StorageManager.getItem("lyrics-plus:visual:gemini-api-key");
