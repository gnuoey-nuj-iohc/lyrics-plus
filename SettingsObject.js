...
const SettingKeys = [
  ...
  "lyrics-plus:visual:perplexity-api-key",
  "lyrics-plus:visual:perplexity-api-key-romaji",
  "lyrics-plus:visual:gemini-api-key",
  "lyrics-plus:visual:perplexity-model",
  ...
  "lyrics-plus:visual:phonetic-language",
];
