// Safe React initialization - get from Spicetify only
// Don't check or use global 'react' variable to avoid conflicts with index.js
// index.js already declares 'const react', so we can't reference it here
const getReact = () => {
  if (typeof Spicetify !== 'undefined' && Spicetify.React) {
    return Spicetify.React;
  }
  // Fallback to window.react if Spicetify.React is not available
  if (typeof window !== 'undefined' && typeof window.react !== 'undefined') {
    return window.react;
  }
  console.error('[Settings] React is not available');
  return null;
};

// Get React hooks safely - always get from React instance to avoid conflicts
const getReactHooks = () => {
  const React = getReact();
  if (!React) return {};
  
  // Always get hooks from React instance, don't use global variables
  return {
...
// Get React instance and hooks
const ReactLib = getReact();
const { useState, useEffect, useCallback, useMemo, useRef } = getReactHooks();

const ButtonSVGComponent = ({ icon, active = true, onClick }) => {
  return ReactLib?.createElement ? ReactLib.createElement(
    "button",
    {
...
const ButtonSVG = ReactLib?.memo ? ReactLib.memo(
  ButtonSVGComponent,
  (prevProps, nextProps) => {
...
const SwapButton = ({ icon, disabled, onClick }) => {
  if (!ReactLib?.createElement) return null;
...
const OverlaySettings = () => {
  ...
  return ReactLib.createElement(
    ...
    ReactLib.createElement(
      ...
      ReactLib.createElement(
        ...
        ReactLib.createElement(
          ...
          ReactLib.createElement("div", { className: "setting-description" },
        ...
        ReactLib.createElement(
          ...
          enabled && !isConnected && ReactLib.createElement(
            "button",
            {
              className: "btn",
    ...
    enabled && ReactLib.createElement(
      "div",
      { className: "setting-row" },
      ReactLib.createElement(
        "div",
  ...
  return ReactLib.createElement(
    ...
    debugInfo.track && react.createElement(
      ...
      ReactLib.createElement("div", {
        ...
        ReactLib.createElement("div", null,
          ReactLib.createElement("span", { style: { color: "rgba(255,255,255,0.5)" } }, "Title: "),
          ReactLib.createElement("span", { style: { color: "#fff" } }, debugInfo.track.title)
        ),
        ReactLib.createElement("div", null,
          ReactLib.createElement("span", { style: { color: "rgba(255,255,255,0.5)" } }, "Artist: "),
          ReactLib.createElement("span", { style: { color: "#fff" } }, debugInfo.track.artist)
        ),
        ReactLib.createElement("div", null,
          ReactLib.createElement("span", { style: { color: "rgba(255,255,255,0.5)" } }, "Album: "),
          ReactLib.createElement("span", { style: { color: "#fff" } }, debugInfo.track.album)
        ),
        ReactLib.createElement("div", null,
          ReactLib.createElement("span", { style: { color: "rgba(255,255,255,0.5)" } }, "Track ID: "),
          ReactLib.createElement("code", {
    ...
    ReactLib.createElement(
      ...
      ReactLib.createElement("div", {
        ...
        ReactLib.createElement("span", null, `API 요청 로그 (${apiLogs.length})`),
        ...
        apiLogs.length === 0
          ...
          : apiLogs.map((log, idx) => react.createElement(
            ...
            ReactLib.createElement(
              ...
              ReactLib.createElement("div", { style: { display: "flex", alignItems: "center", gap: "8px" } },
                // 카테고리 뱃지
    ...
    ReactLib.createElement(
      ...
      ReactLib.createElement("div", {
        ...
        debugInfo.lyrics ? react.createElement(
          ...
          null,
          ReactLib.createElement("div", null,
            ReactLib.createElement("span", { style: { color: "rgba(255,255,255,0.5)" } }, "Provider: "),
            ReactLib.createElement("span", {
              style: {
                color: "#4ade80",
                fontWeight: "600",
          ...
          ReactLib.createElement("div", { style: { marginTop: "8px" } },
            ReactLib.createElement("span", { style: { color: "rgba(255,255,255,0.5)" } }, "Type: "),
          ...
          debugInfo.lyrics.error && react.createElement("div", { style: { marginTop: "8px" } },
            ReactLib.createElement("span", { style: { color: "rgba(255,255,255,0.5)" } }, "Error: "),
            ReactLib.createElement("span", { style: { color: "#ef4444" } }, debugInfo.lyrics.error)
          )
  ...
  return ReactLib.createElement(
    ...
    ReactLib.createElement(
      ...
      ReactLib.createElement(
        "div",
        { className: "setting-row-left" },
        ReactLib.createElement("div", { className: "setting-name" }, name),
        info &&
        ReactLib.createElement("div", {
          className: "setting-description",
          dangerouslySetInnerHTML: {
...
const ConfigSliderComponent = ({ name, defaultValue, disabled, onChange = () => { } }) => {
  ...
  return ReactLib?.createElement ? ReactLib.createElement(ButtonSVG, {
...
const ConfigSlider = ReactLib?.memo ? ReactLib.memo(ConfigSliderComponent) : ConfigSliderComponent;
...
const ConfigFontSelector = ({
  ...
  const fontSelector = ReactLib.createElement(
    "div",
    ...
    useCustomFont
      ...
      : react.createElement(
        ...
        GOOGLE_FONTS.map((font) =>
          ReactLib.createElement("option", { key: font, value: font }, font)
        )
      ),
    ReactLib.createElement(ButtonSVG, {
...
const ConfigAdjust = ({
  ...
  return ReactLib.createElement(
    ...
    ReactLib.createElement("span", { className: "adjust-value" }, value),
    ReactLib.createElement(
      "button",
      {
        className: "adjust-button",
...
const ConfigKeyList = ({ name, defaultValue, onChange = () => { } }) => {
  ...
  return ReactLib.createElement(
    ...
    ReactLib.createElement(
      ...
      ReactLib.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } },
        ReactLib.createElement("div", { className: "setting-name" }, name),
        ReactLib.createElement("button", {
          className: "btn",
          onClick: addKey,
      ...
      keys.map((key, index) =>
        ReactLib.createElement("div", { key: index, style: { display: "flex", gap: "8px" } },
          ReactLib.createElement("input", {
            type: "text",
            value: key,
      ...
      ReactLib.createElement(
        ...
        ReactLib.createElement(
          ...
          ReactLib.createElement(
            ...
            ReactLib.createElement(ServiceAction, {
              item,
              setTokenCallback,
            }),
            ReactLib.createElement(SwapButton, {
...
const ServiceOption = ReactLib?.memo ? ReactLib.memo(ServiceOptionComponent) : ServiceOptionComponent;
...
const ServiceList = ({
  ...
  const renderedItems = items.map((key, index) => {
    ...
    item.name = key;
    return ReactLib.createElement(ServiceOption, {
      item,
      key,
      isFirst: index === 0,
...
const OptionList = ({ type, items, onChange }) => {
  ...
  const renderedItems = (itemList || []).map((item, index) => {
      ...
      return ReactLib.createElement(
        ...
        ReactLib.createElement(
          ...
          ReactLib.createElement(
            "div",
            { className: "setting-row-left" },
            ReactLib.createElement("div", { className: "setting-name" }, item.desc)
          )
        )
      );
    }
    ...
    if (
      ...
      return ReactLib.createElement(item.type, {
        ...item,
        key: index,
        name: item.desc,
        text: item.text,
    ...
    return ReactLib.createElement(
      ...
      ReactLib.createElement(
        ...
        ReactLib.createElement(
          "div",
          { className: "setting-row-right" },
          ReactLib.createElement(item.type, {
            ...item,
            name: item.desc,
            disabled: isDisabled,
            defaultValue:
    ...
    return ReactLib.createElement(
      ...
      ReactLib.createElement(
        ...
        ReactLib.createElement(
          ...
          ReactLib.createElement("h1", null, "ivLyrics"),
          ReactLib.createElement(
            "span",
        ...
        ReactLib.createElement(
          ...
          ReactLib.createElement(
            ...
            ReactLib.createElement("span", null, "GitHub")
          ),
          ReactLib.createElement(
            "button",
            {
            ...
            ReactLib.createElement("span", null, "Discord")
          ),
          ReactLib.createElement(
            "button",
            {
            ...
            ReactLib.createElement("span", null, I18n.t("settingsAdvanced.donate.button"))
          )
        )
      )
    );
    ...
    return ReactLib.createElement(
      ...
      ReactLib.createElement(
        ...
        ReactLib.createElement(
          ...
          ReactLib.createElement("h3", null, title),
...
`,
    ...
    ReactLib.createElement(HeaderSection),
    ReactLib.createElement(
      "div",
      { className: "settings-tabs" },
      ReactLib.createElement(TabButton, {
        id: "general",
    ...
    ReactLib.createElement(
      ...
      ReactLib.createElement(
        ...
        // 언어 설정 섹션
        ReactLib.createElement(SectionTitle, {
          title: I18n.t("sections.language"),
          subtitle: I18n.t("settings.language.desc"),
        }),
        ReactLib.createElement(OptionList, {
          items: [
            {
        ...
        ReactLib.createElement(OverlaySettings),
        ReactLib.createElement(SectionTitle, {
        ...
        ReactLib.createElement(
          ...
          ReactLib.createElement(
            ...
            ReactLib.createElement(
              ...
              ReactLib.createElement(ConfigFontSelector, {
                name: "",
                defaultValue:
                  CONFIG.visual["original-font-family"] ||
                  "Pretendard Variable",
      ...
      ReactLib.createElement(
        ...
        ReactLib.createElement(LocalCacheManager)
      ),
      // 번역 탭 (가사 제공자 포함)
      ReactLib.createElement(
        "div",
        ...
        ReactLib.createElement(ServiceList, {
      ...
      ReactLib.createElement(
        ...
        ReactLib.createElement(OptionList, {
          items: [
            ...
            {
              desc: I18n.t("settingsAdvanced.api.perplexityKey.desc") || "Perplexity API Key (Optional)",
              info: I18n.t("settingsAdvanced.api.perplexityKey.info") || "Enter your Perplexity API key. If provided, it will be used first, falling back to Gemini if it fails.",
      ...
      ReactLib.createElement(
        ...
        ReactLib.createElement(DebugInfoPanel)
      ),
      // 정보 탭
      ReactLib.createElement(
        "div",
        ...
        ReactLib.createElement(
          ...
          ReactLib.createElement(
            ...
            ReactLib.createElement("span", null, "🎵"),
            "ivLyrics"
          ),
          ReactLib.createElement(
            "p",
          ...
          ReactLib.createElement(
            ...
            ReactLib.createElement("strong", null, I18n.t("settingsAdvanced.aboutTab.developer")),
            " ivLis Studio"
          ),
          ReactLib.createElement(
            "p",
            ...
            ReactLib.createElement("strong", null, I18n.t("settingsAdvanced.aboutTab.originalProject")),
            " ivLyrics by khanhas"
          ),
          ReactLib.createElement(
            "p",
        ...
        ReactLib.createElement(OptionList, {
          items: [
            {
              desc: I18n.t("settingsAdvanced.aboutTab.update.disableNotification.desc") || "자동 업데이트 알림 비활성화",
              info: I18n.t("settingsAdvanced.aboutTab.update.disableNotification.info") || "앱 시작 시 업데이트 알림을 표시하지 않습니다.",
              key: "disable-update-notification",
              type: ConfigSlider,
              defaultValue: StorageManager.getItem("ivLyrics:visual:disable-update-notification") === "true",
            },
            {
